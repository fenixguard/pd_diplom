...
class User(AbstractUser):
    ...
    position = models.CharField(verbose_name=_('Должность'), help_text=_('Укажите должность'), max_length=40,
                                blank=True)
    ...
    type = models.CharField(verbose_name=_('Тип пользователя'), choices=USER_TYPE_CHOICES, max_length=10,
                            default='buyer')
...
class Contact(models.Model):
    ...
    person = models.CharField(max_length=50, verbose_name=_('Контактное лицо'), blank=True,
                              help_text=_('Контактное лицо'))
