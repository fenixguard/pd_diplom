...
from jobs.routers import CustomDefaultRouter
...
openapi_view = get_schema_view(title='Shop API', description='API for the shop')

router = CustomDefaultRouter()
router.APIRootView.__doc__ = 'Добро пожаловать в магазин'
